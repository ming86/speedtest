...
print_speedtest_mysing() {
	...
	printf "%-75s\n" "-" | sed 's/\s/-/g' | tee -a $log
        speed_test '' 'Nearby                          '
	printf "%-75s\n" "-" | sed 's/\s/-/g' | tee -a $log
	speed_test '19318' 'Malaysia, Kuala Lumpur (TM)' 'http://speedtest.tm.com.my'
	speed_test '19318' 'Malaysia, Kuala Lumpur (TM)' 'http://speedtest.tm.com.my'
	speed_test '19318' 'Malaysia, Kuala Lumpur (TM)' 'http://speedtest.tm.com.my'
	speed_test '19318' 'Malaysia, Kuala Lumpur (TM)' 'http://speedtest.tm.com.my'
	speed_test '19318' 'Malaysia, Kuala Lumpur (TM)' 'http://speedtest.tm.com.my'
	speed_test '3758' 'Malaysia, Kuala Lumpur (DiGi)' 'http://speedtest.digi.com.my'
	speed_test '3758' 'Malaysia, Kuala Lumpur (DiGi)' 'http://speedtest.digi.com.my'
	speed_test '3758' 'Malaysia, Kuala Lumpur (DiGi)' 'http://speedtest.digi.com.my'
	speed_test '3758' 'Malaysia, Kuala Lumpur (DiGi)' 'http://speedtest.digi.com.my'
	speed_test '3758' 'Malaysia, Kuala Lumpur (DiGi)' 'http://speedtest.digi.com.my'
	speed_test '13623' 'Singapore (SingTel)       ' 'http://speedtest.singnet.com.sg'
	speed_test '13623' 'Singapore (SingTel)       ' 'http://speedtest.singnet.com.sg'
	speed_test '13623' 'Singapore (SingTel)       ' 'http://speedtest.singnet.com.sg'
	speed_test '13623' 'Singapore (SingTel)       ' 'http://speedtest.singnet.com.sg'
	speed_test '13623' 'Singapore (SingTel)       ' 'http://speedtest.singnet.com.sg'
